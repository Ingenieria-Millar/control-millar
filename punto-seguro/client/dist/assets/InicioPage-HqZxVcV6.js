import{p as v}from"./markupHelpers-DBqD6TEF.js";import{w as p}from"./workers.service-CDoOC3hy.js";import{a as g}from"./attempts.service-DOzANjbi.js";import{a as m,i as b}from"./inductionContent.service-CsNUCnS-.js";import"./errorNotifier-B--TSDlC.js";import"./binaryUtils-BLu2Esm7.js";class P{constructor({onNavigate:e}){this.onNavigate=e}async render(e){const[s,r,o,t]=await Promise.all([p.listAll(),g.listAll(),m.listAll(),b.get()]),n=s.length,c=s.filter(a=>(a.documentosFirmadosCount||0)>=9).length,l=r.length,d=r.filter(a=>a.puntaje>=80).length,u=l?Math.round(d/l*100):0,i=o.length>0&&!!(t!=null&&t.quizId);e.innerHTML=`
